...
import GoogleReviewsCarousel from "../Reviews/ReviewCarousel";
          ...
          <div className="relative z-20 container mx-auto px-4 h-full flex items-center">
            <div className="max-w-3xl">
              ...
              <p className="text-lg md:text-xl text-neutral-200 mb-8 text-left max-w-2xl">
                Discover exclusive villas and homestays in the most beautiful
                locations. Perfect for holidays, weddings, and memorable stays.
              </p>
        ...
        <section className="py-20 bg-neutral-900">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-neutral-300 text-lg mb-8 max-w-2xl mx-auto">
              Get in touch with us today and let's make your dream vacation a
              reality
            </p>
            <button
              onClick={() => onNavigate("properties")}
