        ...
        <nav className="flex flex-col h-full">
          ...
          <div className="p-6 border-b border-neutral-200/20">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 bg-gradient-to-br from-neutral-700 to-neutral-900 rounded-lg flex items-center justify-center">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                </svg>
              </div>
              <div>
                <h1 className="text-lg font-bold text-white" style={{ fontFamily: 'Grechen Fuemen, cursive' }}>
                  Cascade
                </h1>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 bg-black border-b border-neutral-200/20 z-40">
        <div className="flex items-center justify-between px-4 py-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h1 className="text-sm font-bold text-white" style={{ fontFamily: 'Grechen Fuemen, cursive' }}>
                Cascade
              </h1>
            </div>
          </div>
