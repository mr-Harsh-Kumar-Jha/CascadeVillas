      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 bg-black border-b border-neutral-200/20 z-40">
        <div className="flex items-center justify-between px-4 py-3">
          <div className="flex items-center gap-2">
            <div className="w-9 h-8 bg-gradient-to-br from-neutral-700 to-neutral-900 rounded-lg flex items-center justify-center">
              <img className="w-9 h-8" src={CascadeLogo} alt="Cascase"/>
            </div>
            <div>
